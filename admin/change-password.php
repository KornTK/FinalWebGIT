...
<html lang="en">
  <head>
    ...
    <title>แอดมิน | เปลี่ยนรหัสผ่าน</title>
  ...
  <section id="container" >
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="logout.php" style="background: #ffffffab;color: #424a5d;border: 2px solid #424a5d !important;">ออกจากระบบ <i class="fa fa-sign-out"></i></a></li>
            	</ul>
            </div>
        </header>
      <aside>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> เปลี่ยนรหัสผ่าน </h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div class="form-group">
                              ...
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">กรอกรหัสผ่านใหม่</label>
                              <div class="col-sm-10">
                              ...
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">กรอกรหัสผ่านใหม่อีกครั้ง</label>
                              <div class="col-sm-10">
                                  <input type="password" class="form-control" name="confirmpassword" value="" >
                              </div>
                          </div>
                          <div style="margin-left:100px;">
                          <input type="submit" name="Submit" value="ยืนยัน" class="btn btn-theme"></div>
                          </form>
                      </div>
                  </div>
              </div>

  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-solid fa-cog fa-spin"></i> เปลี่ยนรหัสผ่าน </h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">รหัสผ่านเก่า</label>
                              <div class="col-sm-10">
                              ...
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">รหัสผ่านใหม่</label>
                              <div class="col-sm-10">
                              ...
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">รหัสผ่านใหม่อีกครั้ง</label>
                              <div class="col-sm-10">
                                  <input type="password" class="form-control" name="confirmpassword" value="" >
                              </div>
                          </div>
                          <div style="margin-left:100px;">
                          <input type="submit" name="Submit" value="เปลี่ยนรหัสผ่าน" class="btn btn-theme"></div>
                          </form>
                      </div>
                  </div>
              </div>
